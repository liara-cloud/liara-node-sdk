# Liara JavaScript SDK [![Build Status](https://travis-ci.org/liara-ir/liara-node-sdk.svg?branch=master)](https://travis-ci.org/liara-ir/liara-node-sdk)
...
| Param  |  Type | Description  |
|---|---|---|
| `policy`  | _object_  | Policy object created by liaraClient.newPostPolicy() |
